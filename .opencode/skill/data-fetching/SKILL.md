...
-> Use EXPO_PUBLIC env vars with .env.development and .env.production files

User: "Where should I put my API key?"
-> Client-safe keys: EXPO_PUBLIC in .env. Secret keys: non-prefixed env vars in API routes only
