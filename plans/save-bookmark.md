...
#### Verification:
- [ ] Clicking "Add New" opens the bottom sheet
- [ ] ESC key closes the sheet
- [ ] Clicking outside or on backdrop closes the sheet
...
#### Verification:
- [ ] Input is focused when sheet opens
- [ ] If clipboard contains a URL, it auto-pastes
- [ ] User can manually type/paste URLs
...
#### Verification:
- [ ] Preview API is called after URL input (with debounce)
- [ ] Loading spinner shows during API call
- [ ] Error messages display for failed previews
- [ ] Preview data is correctly typed
...
- [ ] Images load with fallback states
- [ ] Content type badges use correct colors
...
#### Verification:
- [ ] Save button is disabled without valid preview
- [ ] Loading state shows during save
- [ ] Success closes sheet and shows toast
- [ ] Duplicate bookmarks show appropriate message
- [ ] Bookmarks list updates after save
...
#### Verification:
- [ ] Malformed URLs show helpful error messages
- [ ] Retry button appears for failed previews
- [ ] Timeouts handled gracefully
- [ ] Long content doesn't break layout
- [ ] Screen readers work correctly
- [ ] All URL types handled appropriately
