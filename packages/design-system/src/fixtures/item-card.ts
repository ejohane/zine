export interface DesignSystemItemCardFixture {
  id: string;
  title: string;
  creator: string;
  creatorImageUrl?: string | null;
  thumbnailUrl?: string | null;
  contentType: 'ARTICLE' | 'PODCAST' | 'VIDEO' | 'POST';
  provider: 'YOUTUBE' | 'SPOTIFY' | 'SUBSTACK' | 'WEB';
...
} satisfies Record<string, DesignSystemItemCardFixture>;
