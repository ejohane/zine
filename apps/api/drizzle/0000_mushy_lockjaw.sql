CREATE TABLE `bookmark_tags` (
	...
	`created_at` integer DEFAULT '"2025-04-06T03:58:54.918Z"' NOT NULL,
...
CREATE TABLE `bookmarks` (
	...
	`created_at` integer DEFAULT '"2025-04-06T03:58:54.917Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2025-04-06T03:58:54.917Z"' NOT NULL,
...
CREATE TABLE `author` (
	`id` integer PRIMARY KEY NOT NULL,
	`created_at` integer DEFAULT '"2025-04-06T03:58:54.915Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2025-04-06T03:58:54.915Z"' NOT NULL,
	`name` text NOT NULL,
	`image` text,
	`description` text
);
...
CREATE TABLE `author_services` (
	...
	`service_url` text,
	`created_at` integer DEFAULT '"2025-04-06T03:58:54.916Z"' NOT NULL,
...
CREATE TABLE `content` (
	`id` integer PRIMARY KEY NOT NULL,
	`created_at` integer DEFAULT '"2025-04-06T03:58:54.917Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2025-04-06T03:58:54.917Z"',
	`url` text NOT NULL,
	`title` text,
	`description` text,
...
CREATE TABLE `tags` (
	`id` integer PRIMARY KEY NOT NULL,
	`name` text NOT NULL,
	`created_at` integer DEFAULT '"2025-04-06T03:58:54.911Z"' NOT NULL
);
--> statement-breakpoint
