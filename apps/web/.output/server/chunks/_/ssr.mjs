import { createRootRoute, Link, Outlet, HeadContent, Scripts, createFileRoute, lazyRouteComponent, RouterProvider, createRouter as createRouter$1 } from '@tanstack/react-router';
...
async function loadVirtualModule(id) {
  switch (id) {
    ...
    case VIRTUAL_MODULES.startManifest:
      return await import('./_tanstack-start-manifest_v-B53PRQbU.mjs');
...
const appCss = "/assets/App-C1hn0JOW.css";
const Route$2 = createRootRoute({
  head: () => ({
    meta: [{
      ...
      title: "Zine - Personal Bookmark Manager"
    }, {
      name: "description",
      content: "Your personal bookmark manager built with TanStack Start"
    }],
    links: [{
      rel: "stylesheet",
      href: appCss
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxs(QueryClientProvider, { client: queryClient, children: [
    /* @__PURE__ */ jsxs("div", { className: "p-2 flex gap-2", children: [
      ...
      /* @__PURE__ */ jsx(Link, { to: "/bookmarks", activeProps: {
        className: "font-bold"
      }, children: "Bookmarks" })
    ] }),
    /* @__PURE__ */ jsx("hr", {}),
...
const $$splitComponentImporter$1 = () => import('./bookmarks-CHR5Dlhs.mjs');
const Route$1 = createFileRoute("/bookmarks")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import('./index-DAdcpH81.mjs');
const Route = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const BookmarksRoute = Route$1.update({
  id: "/bookmarks",
  path: "/bookmarks",
