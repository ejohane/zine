...
export function AddBookmarkSheet({ open, onOpenChange }: AddBookmarkSheetProps) {
  ...
  React.useEffect(() => {
    if (open) {
      ...
      }, 500) // Increased for Silk sheet animation
  ...
  // Use conditional rendering for controlled state since Silk doesn't support open prop
  if (!open) {
    return null
  }
    ...
    <SheetRoot license="commercial">
      <SheetPortal>
        <SheetView>
          ...
          >
            {/* Drag handle */}
            <SheetHandle className="mx-auto w-12 h-1.5 rounded-full bg-gray-300 dark:bg-gray-600 mt-3 mb-4 flex-shrink-0" />
            
            {/* Header */}
            <div className="px-4 pb-4 flex-shrink-0">
              <h2 className="text-xl font-semibold">Add Bookmark</h2>
              <p id="add-bookmark-description" className="text-sm text-muted-foreground mt-1">
                  ...
                  <div className="relative">
                    ...
                    {url && (
                      <button
                        ...
                        className="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground transition-colors p-1 z-10 touch-manipulation"
                  ...
                  <div className="rounded-lg border border-red-200 bg-red-50 dark:border-red-900 dark:bg-red-950 p-4">
                    <div className="flex items-start justify-between">
                      ...
                      <Button
                        ...
                        className="text-red-600 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300 touch-manipulation"
                      >
                        Retry
                      </Button>
                    </div>
            ...
            {preview && !isLoadingPreview && (
              <div className="px-4 pt-2 pb-4 border-t border-gray-200 dark:border-zinc-800 flex-shrink-0">
                <Button
