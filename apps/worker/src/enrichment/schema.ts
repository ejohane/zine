...
export const EntityRelationshipSchema: z.ZodType<EntityRelationship, z.ZodTypeDef, unknown> =
  z.preprocess((value) => {
...
export const EnrichmentQueueMessageSchema = z.object({
  ...
  trigger: z.enum(['manual_save', 'inbox_bookmark', 'article_body_ready', 'backfill']),
...
export const EnrichmentModelOutputSchema: z.ZodType<EnrichmentModelOutput, z.ZodTypeDef, unknown> =
  z.object({
    summary: z.object({
